...
set ylabel "Basin Average (mm)" font "Helvetica,20"
set xtics font "Time-Roman,18"
set ytics font "Time-Roman,18"
set title "Water balance ($Initial_Time[0]/$Initial_Time[1]/$Initial_Time[2] - $Final_Time[0]/$Final_Time[1]/$Final_Time[2])" font "Helvetica,25";
set xdata time
set timefmt "%Y %m %d"
...
set ytic auto                          # set ytics automatically
set xlabel "Time (day)" font "Helvetica,20"
set ylabel "Basin Average (%)" font "Helvetica,20"
set xtics font "Time-Roman,18"
set ytics font "Time-Roman,18"
set title "Soil Moisture Products ($Initial_Time[0]/$Initial_Time[1]/$Initial_Time[2] - $Final_Time[0]/$Final_Time[1]/$Final_Time[2])" font "Helvetica,25";
set xdata time
set timefmt "%Y %m %d"
set format x $xtickfmt
set size 1.2,0.85

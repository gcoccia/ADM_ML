...
<ul class="nav nav-pills data-extraction">
  ...
  <li><a href="javascript:void(0)" id="point" class="de-box" onclick='Update_Listeners("point")'><?php echo $_("Select Point")?></a></li>
  <li><a href="javascript:void(0)" id="spatial" class="de-box" onclick='Update_Listeners("spatial")'><?php echo $_("Select Area")?></a></li>
</ul>   

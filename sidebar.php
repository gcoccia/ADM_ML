    ...
    <?php foreach($group->datatype as $datatype) { ?>
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a id="<?php echo $datatype['name']."--".$dataset['name'] ?>" href="javascript:void(0)"><i></i><?php echo $dataset['title']?></a></li>
          <?php } ?>
        </ul>
      </li>
    <?php } ?>
              ...
              <?php foreach($group->datatype as $datatype) { ?>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="nav-header"><?php echo $_("Dataset")?></li>
                    <?php foreach($datatype->dataset as $dataset) { ?>
                      <li><a id="<?php echo $datatype['name']."--".$dataset['name'] ?>" href="javascript:void(0)"><i class="icon-plus-sign" style="color:#5cb85c"></i><?php echo $dataset['title']?></a></li>
                    <?php } ?>
                  </ul>
                </li>
      <?php   } ?>
